...
{
    /// <summary>
    /// Operator symbol serializer
    /// </summary>
    public class IonOperatorSerializer : AbstractIonTypeSerializer<IonOperator>
    {
        ...
        public override string GetIonValueText(IonOperator ionValue, SerializingContext context)
        {
    ...
    /// <summary>
    /// Ion Identifier serializer
    /// </summary>
    public class IonIdentifierSerializer : AbstractIonTypeSerializer<IonIdentifier>
    {
        public const string IonSymbol = "ion-symbol";
        public const string NullSymbol = "null-symbol";
        ...
        public override string GetIonValueText(IonIdentifier ionValue, SerializingContext context)
        {
            return ionValue.Value switch
            {
                null => "null.symbol",
    ...
    /// <summary>
    /// Ion Quoted symbol serializer
    /// </summary>
    public class IonQuotedSymbolSerializer : AbstractIonTypeSerializer<IonQuotedSymbol>
    {
        public const string IonSymbol = "ion-symbol";
        public const string NullSymbol = "null-symbol";
        ...
        public override string GetIonValueText(IonQuotedSymbol ionValue, SerializingContext context)
        {
            return ionValue.Value switch
            {
                null => "null.symbol",
