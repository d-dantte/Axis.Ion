...
{
    public class IonTimestampStreamer : AbstractIonTypeStreamer<IonTimestamp>
    {
        ...
        public override string GetIonValueText(IonTimestamp ionValue, StreamingContext context)
        {
