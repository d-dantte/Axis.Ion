...
{
    public class IonClobStreamer : AbstractIonTypeStreamer<IonClob>
    {
        ...
        override public string GetIonValueText(IonClob ionValue, StreamingContext context)
        {
        ...
        private string WrapLines(string[] lines, StreamingContext context)
        {
            return lines.Length switch
            {
                ...
                _ => context
                    .Indentation(1)
                    .ApplyTo(indentation => lines.Select(line => $"{indentation}{line}"))
