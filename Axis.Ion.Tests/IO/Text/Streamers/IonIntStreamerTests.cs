...
namespace Axis.Ion.Tests.IO.Text.Streamers
{
    ...
    public class IonIntStreamerTests
    {
        ...
        public void StreamText()
        {
            ...
            var ionIntStreamer = new IonIntSerializer();
            var text = ionIntStreamer.SerializeText(ionInt, context);
            var textAnnotated = ionIntStreamer.SerializeText(ionIntAnnotated, context);
            ...
            ionIntStreamer = new IonIntSerializer();

            // no separator
            context.Options.Ints.NumberFormat = SerializerOptions.IntFormat.Decimal;
            text = ionIntStreamer.SerializeText(ionInt, context);
            var ntext = ionIntStreamer.SerializeText(nionInt, context);
            textAnnotated = ionIntStreamer.SerializeText(ionIntAnnotated, context);
            var ntextAnnotated = ionIntStreamer.SerializeText(nionIntAnnotated, context);
            ...
            text = ionIntStreamer.SerializeText(ionInt, context);
            ntext = ionIntStreamer.SerializeText(nionInt, context);
            textAnnotated = ionIntStreamer.SerializeText(ionIntAnnotated, context);
            ntextAnnotated = ionIntStreamer.SerializeText(nionIntAnnotated, context);
        ...
        public void TryParse()
        {
            ...
            var context = new SerializingContext(new SerializerOptions());
            var streamer = new IonIntSerializer();
