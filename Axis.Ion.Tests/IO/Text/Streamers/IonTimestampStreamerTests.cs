...
namespace Axis.Ion.Tests.IO.Text.Streamers
{
    ...
    public class IonTimestampStreamerTests
    {
        ...
        public void StreamText()
        {
            ...
            var ionTimestampStreamer = new IonTimestampSerializer();
            var text = ionTimestampStreamer.SerializeText(ionTimestamp, context);
            var textAnnotated = ionTimestampStreamer.SerializeText(ionTimestampAnnotated, context);
            ...
            ionTimestampStreamer = new IonTimestampSerializer();

            #region Year precision
            context.Options.Timestamps.TimestampPrecision = SerializerOptions.TimestampPrecision.Year;
            text = ionTimestampStreamer.SerializeText(ionTimestamp, context);
            textAnnotated = ionTimestampStreamer.SerializeText(ionTimestampAnnotated, context);
        ...
        public void TryParse()
        {
            ...
            var streamer = new IonTimestampSerializer();
